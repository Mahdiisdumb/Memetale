...
dogshrine = scr_marker(0, 0, 1057);

with (dogshrine)
    depth = 900000;

donationbox = scr_marker(137, 76, 1067);
...
if (doglevel >= 1) {
    fairylights = scr_marker(46, 6, 1069);
...
if (doglevel >= 6) {
    boombox = scr_marker(232, 80, 1062);
...
if (doglevel >= 4) {
    photo1 = scr_marker(194, 160, 1070);
...
if (doglevel >= 11) {
    dogtap = scr_marker(257, 136, 1066);
...
if (doglevel >= 12) {
    blueprint = scr_marker(88, 162, 1061);
