...
if (con == 73) {
    ...
    g = scr_marker(undyne.x, undyne.y, 1375);
    g.depth = 500000;
...
if (con == 99) {
    if (undyne.y >= 5) {
        ...
        hotchocolate2.breaksprite = 1594;
        hotchocolate2.myh = -1;
        hotchocolate2.mya = 3;
...
if (con == 152) {
    ...
    if (undyne.image_index >= 12) {
        undyne.image_speed = 0;
        pot = scr_marker(140, -20, 1583);
        pot.vspeed = 6;
        pot.depth = 500000;
        box = scr_marker(160, -20, 1582);
        box.vspeed = 6;
        box.depth = 500000;
        con = 154;
    }
...
if (con == 212) {
    snd_play(20);
    spear2 = scr_marker(pot.x + 10, -35, 1539);
...
if (con == 255) {
    ...
    vol = 0;
    potb = scr_marker(pot.x, pot.y + 2, 1585);
    ...
    f = scr_marker(60, 140, 1226);
    f.image_speed = 0.6;
    f.depth = 400000;
    f = scr_marker(80, 40, 1226);
    f.image_speed = 0.5;
    f.depth = 400000;
    f = scr_marker(200, 40, 1226);
    f.image_speed = 0.4;
    f.depth = 400000;
    f = scr_marker(220, 100, 1226);
    f.image_speed = 0.6;
    f.depth = 400000;
    f = scr_marker(180, 160, 1226);
    f.image_speed = 0.7;
    f.depth = 400000;
