...
if (active == 1) {
    if (global.cast_type == 0) {
        ...
        scr_drawtext_centered_scaled(col2_x, mon.y - 30, scr_gettext("castroll_by_Mahdiisdumb"), 1, 1);
        ...
        scr_drawtext_centered_scaled(col1_x, mon.y - 30, scr_gettext("castroll_by_Luke_and_Mahdiisdumb"), 1, 1);
    ...
    if (global.cast_type == 1) {
        ...
        scr_drawtext_centered_scaled(col1_x - 20, mon.y - 30, scr_gettext("castroll_by_Mahdiisdumb_and_Luke"), 1, 1);
        ...
        scr_drawtext_centered_scaled(col2_x + 20, mon.y - 30, scr_gettext("castroll_by_Luke_and_Mahdiisdumb"), 1, 1);
    ...
    if (global.cast_type == 2) {
        ...
        scr_drawtext_centered_scaled(col1_x, mon.y - 30, scr_gettext("castroll_by_Mahdiisdumb_2"), 1, 1);
