    ...
    if (ch == "^" && string_char_at(originalstring, n + 1) != "0") {
        ...
        if (ch == "R") {
            ...
            if (sprite != -4) {
                ...
                if (myfont == 1 || myfont == 13)
                    icon_scale = 2;
                
                if (myfont == 1 || myfont == 2)
                    spritey += (1 * icon_scale);
                
                if (myfont == 16)
                    spritex -= 1;
                
                if (myfont == 9 && icontype == 1)
