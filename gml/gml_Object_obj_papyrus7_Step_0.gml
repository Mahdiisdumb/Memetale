...
if (conversation == 6 && instance_exists(OBJ_WRITER) == 0) {
    ...
    dcannon = scr_marker(x + 170, 240, 1284);
    dcannon.vspeed = -0.7;
    
    with (dcannon)
        depth = 4000;
    
    dspear1 = scr_marker(x + 100, 310, 1282);
    ...
    dspear2 = scr_marker(x + 100, -60, 1282);
    dspear2.vspeed = 0.9;
    dspike = scr_marker(x + 20, -100, 1285);
    dspike.vspeed = 1.2;
    ddog = scr_marker(x + 170, -90, 1283);
    ddog.vspeed = 1.2;
