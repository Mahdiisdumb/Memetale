if (conversation == 1 && instance_exists(obj_dialoguer) == 0) {
    ...
    obj_toroverworld3.rsprite = 1202;
    obj_toroverworld3.usprite = 1205;
...
if (instance_exists(obj_toroverworld3) && conversation == 2) {
    if (obj_toroverworld3.path_position == 1) {
        obj_toroverworld3.usprite = 1200;
        obj_toroverworld3.rsprite = 1195;
        obj_mainchara.x += 33;
        alarm[2] = 1;
...
if (conversation == 3 && instance_exists(obj_dialoguer) == 0) {
    ...
    ruff = scr_marker(obj_toroverworld3.x, obj_toroverworld3.y, 1189);
