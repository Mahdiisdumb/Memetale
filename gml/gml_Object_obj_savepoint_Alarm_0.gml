...
if (scr_murderlv() >= 8 && global.flag[27] == 0) {
    if (room == room_water2 || room == room_water4 || room == room_water_savepoint1 || room == room_water_preundyne || room == room_water_trashsavepoint || room == room_water_friendlyhub || room == room_water_undynefinal || room == room_water19 || room == room_water_mahdiitown) {
        if (global.flag[27] == 0) {
            global.msc = 0;
