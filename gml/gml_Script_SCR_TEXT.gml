switch (argument0) {
    ...
    case 552:
        ...
        if (global.choice == 0) {
            ...
            obj_mainchara.dsprite = 1098;
            obj_mainchara.lsprite = 1099;
        } else {
            scr_sansface(0, 0);
        ...
        if (doak == 0) {
            if (global.flag[85] == 0) {
                if (global.choice == 0) {
                    ...
                    obj_mainchara.dsprite = 1104;
                    obj_mainchara.rsprite = 1106;
                    obj_mainchara.lsprite = 1107;
                    obj_mainchara.usprite = 1105;
                } else {
