...
if (con == 15 && global.interact == 0) {
    global.interact = 1;
    global.flag[17] = 0;
    bigweb = scr_marker(582, 84, 1900);
    bigweb.depth = 99999;
    muffet = scr_marker(635, 96, 1901);
    muffet.depth = 99998;
...
if (con == 16.1) {
    ...
    ss1 = scr_marker(428, 180, 1903);
    ss2 = scr_marker(438, 170, 1903);
    ss1.image_speed = 0.25;
    ss1.hspeed = 4;
    ss2.hspeed = 3.5;
    ss2.image_speed = 0.25;
    ss3 = scr_marker(854, 180, 1903);
    ss4 = scr_marker(864, 170, 1903);
    ss3.hspeed = -4;
